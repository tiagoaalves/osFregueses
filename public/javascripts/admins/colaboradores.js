function listColaboradores() {
  ...
  function removeUser(user){
    ...
    swal({title: "Colaborador eliminado com sucesso!", type:"success"});
    listColaboradores();
    }
  ...
  function saveUser() {
    ...
    swal({title: "Colaborador registado com sucesso!", type:"success"});
    listColaboradores();
    }
    }).then(function (result) {console.log(result);
    }).catch(function (err) {alert("Submission error"); console.error(err);
    ...
    swal({title: "Colaborador alterado com sucesso!", type:"success"});
    listColaboradores();
    }
    }).then(function (result) {console.log(result);
    }).catch(function (err) {alert("Submission error"); console.error(err);
